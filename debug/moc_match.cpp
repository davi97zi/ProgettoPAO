...
QT_MOC_LITERAL(1, 6, 14), // "eseguiAbilitaP"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 10) // "sendAction"

    },
    "Match\0eseguiAbilitaP\0\0sendAction"
};
...
void Match::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->eseguiAbilitaP((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->sendAction((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Match::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Match::eseguiAbilitaP)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Match::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Match.data,
...
// SIGNAL 0
void Match::eseguiAbilitaP(QString _t1)
{
